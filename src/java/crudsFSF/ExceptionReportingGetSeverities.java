 ...
 */
@WebServlet(name = "ExceptionReportingGetSeverities", urlPatterns = {"/ExceptionReportingGetSeverities"})
public class ExceptionReportingGetSeverities extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = getMySqlConnection()) {
            ...
            String simpleProc = "{ call getTXNExceptionseverity( ? ) }";
            ...
            Logger.getLogger(ExceptionReportingGetSeverities.class.getName()).log(Level.SEVERE, null, ex);
            ...
            response.sendRedirect("index.html?Success=Could Not get getTXNExceptionseverity!");
        }
